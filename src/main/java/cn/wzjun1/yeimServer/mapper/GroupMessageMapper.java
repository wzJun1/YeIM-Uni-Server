...
public interface GroupMessageMapper extends BaseMapper<GroupMessage> {
    ...
    List<GroupMessage> listMessageByNextMessageId(@Param("userId") String userId, @Param("conversationId") String conversationId, @Param("nextMessageId") String nextMessageId, @Param("limit") Integer limit);
